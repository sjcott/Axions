...
const double pos1s[2] = {0, -0.25*(nz-1)*dz}; // y and z coordinates
const double pos1a[2] = {0, 0.25*(nz-1)*dz};

const double pos2s[2] = {0.25*(nx-1)*dx, 0}; // x and y coordinates
const double pos2a[2] = {-0.25*(nx-1)*dx, 0}; 
